...
# === CONFIGURACIÓN ===
BASE_DIR     = './'  # Carpeta que contiene los subdirectorios labels_*_t<threshold>
IMAGE_DIR    = os.path.expanduser(
    '~/Documents/PROYECTO/Detección_particulas/Datasets/Kaggle/archive_golden/'
    'Small Object dataset/train/images'
)
...
# 1) Detectar umbrales disponibles
